...
import 'package:formvalidators/src/providers/usuario_provider.dart';
import 'package:formvalidators/src/utils/utils.dart';
...
class RegistroPage extends StatelessWidget {
  ...
  _registro( LoginBloc bloc, BuildContext context ) async{
    ...
    Map info = await usuarioProvider.crearUsuario(bloc.email, bloc.password);
        ...
        Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              Text('Haminton Arevalo', style: TextStyle(color: Colors.white, fontSize: 25.0))
            ],
          ),
        )
      ],
